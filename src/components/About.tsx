  ...
  const features = [
    {
      ...
      description: "Access to 50+ skilled photographers with experience in university events and professional shoots."
    },
    {
      icon: Calendar,
      title: "Easy Booking Process",
      description: "Simple online booking form - submit your request and get matched with the perfect photographer."
    },
    {
      icon: Users,
      title: "Campus Focused",
      description: "Specialized in university events, Greek life, clubs, and student organization photography."
    }
  ];
