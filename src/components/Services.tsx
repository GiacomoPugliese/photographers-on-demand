  ...
  const services = [
    {
      ...
      description:
        "Professional headshots for LinkedIn, social media, and professional profiles.",
      icon: ChurchIcon,
      image: headshotImage,
      features: [
        "Iconic Duke Background",
    ...
    },
    {
      ...
      description:
        "Capture your special graduation moment with professional photography that you'll treasure forever.",
      icon: GraduationCap,
    ...
    {
      title: "Sepcial Requests",
      description:
        "Complete event coverage for clubs, Greek life, parties, presentations, performances, and more.",
      icon: Users2,
      image: eventImage,
      features: [
        "Full event coverage",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Professional photography services tailored for the university
            community
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card
              key={index}
              className="service-card border-0 photo-shadow hover:shadow-xl transition-all duration-300 group"
            >
